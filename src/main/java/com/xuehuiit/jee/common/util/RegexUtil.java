...
public final class RegexUtil
{
     ...
     * 从url中提取域名信息
     */
    public static final String url_domain = "(http://|ftp://)[a-zA-Z0-9]+.[a-zA-Z0-9]+(.[a-zA-Z0-9]*/|\\?)";
  ...
  /***************************************************************************
	 ...
	 *            匹配规则
	 **************************************************************************/
	public static String containMatch(String inputValue, String reg) {
	 ...
	 *            匹配规则
	 **************************************************************************/
	public static String cycleMatch(String inputValue, String reg, final int groupid) {
	...
	public static void main(String a[])
	{
		 ...
		 /* try
          {
                 ...
                 PatternMatcher matcher = new Perl5Matcher();
                 MatchResult matchResult=matcher.getMatch();
                  String http="http://dddd.suncer.com:8080?login=true";
        ...
        //一个提取字符串中的中括号 [ ] 包含的字符的例子
		   ...
		   System.out.println(RegexUtil.isHardRegexpValidate("13124132", RegexUtil.positive_integer_regexp));
		   //System.out.println(RegexUtil.isSoftRegexpValidate("fx19800215@163.com",RegexUtil.email_regexp));                
           String newUrl = null;
           newUrl = RegexUtil.containMatch("http://bbs.pdafans.com/forumdisplay.php?fid=183&filter=type&typeid=163&area=",RegexUtil.url_domain);
